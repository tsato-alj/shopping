		...
		<div class="container maincontent">
			<div class="row width100margin0">
				<div class="col-md-8">
					...
					<p>商品イメージの登録が完了しました。引き続き商品説明を追加ください。</p>
					<section id="record">
								...
								<div class="container formlist">
									<form class="center-block" method="post" action="adddescription">
										<div class="col-md-6 form-line">
											<div class="form-group">
								  				<label for ="item-description">Description</label>
								  			 	<textarea  class="form-control" id="description" name="description" placeholder="Please enter the descpription"></textarea>
